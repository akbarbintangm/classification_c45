        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="html/index.html" class="logo-link">
                    <img class="logo-light logo-img" src="{{ asset('lib/images/logo.png') }}"
                        srcset="{{ asset('lib/images/logo2x.png') }} 2x" alt="logo">
                    <img class="logo-dark logo-img" src="{{ asset('lib/images/logo-dark.png') }}"
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    ...
                                    <li><a href="html/user-profile-activity.html"><em
                                                class="icon ni ni-activity-alt"></em><span>Log Activity</span></a>
                                    </li>
                                    <li>
                                        <a data-turbolinks="false"><em class="icon ni ni-moon"></em><span>Dark Mode</span> <input type="checkbox" class="ml-5 pl-2 dark-switch-2" style="cursor: pointer;"></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="dropdown-inner">
