!(function (NioApp, $) {
    ...
    var salesRevenue = {
        ...
        datasets : [{
            label : "Sales Revenue",
            color : [NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2), NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),"#e67e22"],
    ...
    var activeSubscription = {
        ...
        datasets : [{
            label : "Active User",
            color : [NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),NioApp.hexRGB("#e67e22", .2),"#e67e22"],
    ...
    var salesOverview = {
        ...
        datasets : [{
            ...
            color : "#2F2B65",
            background : NioApp.hexRGB('#2F2B65',.3),
                ...
                options: {
                    ...
                    scales: {
                        yAxes: [{
                            ...
                            gridLines: { 
                                color: NioApp.hexRGB("#2F2B65",.2),
                                tickMarkLength:0,
                                zeroLineColor: NioApp.hexRGB("#2F2B65",.2)
                            },
