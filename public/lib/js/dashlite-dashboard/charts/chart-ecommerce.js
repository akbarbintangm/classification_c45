!(function (NioApp, $) {
    ...
    var totalSales = {
        ...
        datasets : [{
            label : "Sales",
            color : "#e67e22",
            background : NioApp.hexRGB('#e67e22',.25),
    ...
    var totalOrders = {
        ...
        datasets : [{
            label : "Orders",
            color : "#2F2B65",
            background : NioApp.hexRGB('#2F2B65',.25),
    ...
    var salesStatistics = {
        ...
        datasets : [{
            ...
            color : "#e67e22",
            dash : 0,
            background : NioApp.hexRGB('#e67e22',.15),
    ...
    var trafficSources = {
        ...
        datasets : [{
            borderColor : "#fff",
            background : ["#e67e22","#e85347","#ffa9ce","#f9db7b"],
    ...
    var orderStatistics = {
        ...
        datasets : [{
            borderColor : "#fff",
            background : ["#e67e22","#e85347","#816bff"],
            data: [4305, 259, 682]
        }]
    };
